...
folder="/home/atlan/aosp"
rom_name="AospExtended"*.zip
gapps_command="WITH_GAPPS"
with_gapps="no"
build_type="userdebug"
device_codename="surya"
use_brunch="no"
OUT_PATH="$folder/out/target"
lunch="aosp"
user="atlan"
tg_username="@atlanprime"
ccache_location="/home/atlan/ccache" # Default you can change it 
